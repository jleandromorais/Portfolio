...
const WORDS = ["Estudante de Analise e desenvolvimento de sistemas", "Apaixonado por Tecnologia"];
const TECH_STACK = ["React", "Javascript", "Java", "Tailwind","Spring boot","MySQL"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/jleandromorais" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/leandro-morais-a081912a0/" },
